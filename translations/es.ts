export default {
  ...
  loginScreen: {
    ...
    help: 'En caso de problemas para iniciar sesión, por favor contacte a',
    technicalSupport: 'soporte técnico'
  },
  Event: {
    eventAbout: 'Acerca del evento',
    eventFeaturedIn: 'Destacado en',
    location: 'Lugar'
  },
  Registration: {
    eventApprovalRequired: 'Aprobación requerida',
    eventApprovalDescription:
      'Tu registro está sujeto a la aprobación del anfitrión.',
    eventRequestToJoin: 'Solicitar unirse',
    eventRegistration: 'Registro',
    eventRegistrationDescription:
      'Rellena el formulario a continuación para solicitar unirte al evento.',
    eventFormName: 'Nombre',
    eventFormNamePlaceholder: 'Juan Pérez',
    eventFormNameDescription: 'Este es tu nombre completo.',
    eventFormEmail: 'Correo electrónico',
    ...
    eventFormEmailError: 'Por favor, introduce una dirección de correo válida.',
    ...
    registrationPendingDescription:
      'Tu registro está siendo revisado por los organizadores. Te notificaremos una vez sea aprobado.',
    registrationConfirmedDescription:
      'Tu registro ha sido confirmado. Puedes ver tus entradas a continuación.',
    viewMyTickets: 'Ver mis entradas',
    alreadyRegistered: 'Ya estás registrado',
    alreadyRegisteredDescription:
      'Ya te has registrado para este evento. Puedes ver tus entradas a continuación.',
